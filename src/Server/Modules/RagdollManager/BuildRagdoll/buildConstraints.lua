...
local ConstraintsFolder = ReplicatedStorage.Assets.Misc.RagdollConstraints
local getLastWordFromPascaleCase = require(script.Parent:WaitForChild("getLastWordFromPascalCase"))

local constraints = {}
for _, v in ConstraintsFolder:GetChildren() do
...
return function(attachmentMap)
	...
	for attachmentName,jointData in attachmentMap do
		--// humanoid has undergone changes since this module was created. now, we want a RigidConstraint linked to the root
